...
class TestLoader(object):
    ...
    def discover(self, start_dir, pattern='test*.py', top_level_dir=None):
        ...
        New in Python3.5: load_tests is called even on the first start_dir
        package, and infinite recursion is avoided by memoising where
        load_tests has been called.
        """
    ...
    def _find_test_path(
        ...
        if os.path.isfile(full_path):
            ...
            try:
                ...
                return _make_failed_import_test(name, self.suiteClass), False
            else:
